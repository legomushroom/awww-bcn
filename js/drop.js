(function() {
  ...
  Drop = (function() {
    ...
    Drop.prototype.run = function() {
      var $el, angle, centerX, centerY, coef, delay, delayStep, i, left, left2, step, stepCalc, top, top2, wWidth, _i, _j, _k, _len, _ref, _results;
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        if (left >= -10) {
          ...
          $el.velocity({
            ...
            delay: ((10 - this.o.i) * 50 * coef) + delay + helpers.rand(0, delayStep) + 4250 + wWidth / 4,
            duration: 1000 * coef
          });
        }
